...
<head>
  <meta charset="UTF-8">
  <title>Green Enterpreneur SignUp</title>
...
<div class="container" id="container">
	<div class="form-container sign-in-container">
		<form:form method="post" action="/green-enterpreneur-register" modelAttribute="user">
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-right">
				...
				<button onclick="location.href = '/green-enterpreneur-login';" id="signIn">Sign In</button>
			</div>
		</div>
	</div>
</div>
