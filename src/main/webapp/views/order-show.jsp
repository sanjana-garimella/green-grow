    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Thank you for Shopping with us..<span>Shop</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
...
%>
	                				...
	                				<a href="/index-1" class="btn btn-outline-primary-2 btn-order btn-block">Continue Shopping</a>
	                			</div><!-- End .summary -->
	                		</aside><!-- End .col-lg-3 -->
	                	</div><!-- End .row -->
	                </div><!-- End .container -->
