...
<head>
    ...
    <title>GreenGrow - Ecofriendly Store</title>
        ...
        <main class="main">
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container d-flex align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/index-1">Home</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title">Dark yellow lace cut out swing ecofriendly dress</h1><!-- End .product-title -->
                                    ...
                                    <div class="product-content">
                                        <p>Give a smart update to your work wear with this trendy monochrome jumpsuit for women by and Style the wrap style sleeveless jumpsuit with block heels and round hoop earrings. Grab the trendy biodegradable long jumpsuit online now. </p>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="product-desc-tab" role="tabpanel" aria-labelledby="product-desc-link">
                                <div class="product-desc-content">
                                    ...
                                    <p>Christy Dawn’s designs are known for being made out of deadstock fabric leftover from major fashion houses and would otherwise end up in a landfill. In partnership with Oshadi Collective, it recently introduced its Organic Cotton Collection. Each piece is made with organic cotton and colored using natural or organic dyes. In 2019​,​ Christy Dawn also worked with Oshadi Collective to plant cotton seeds on a regenerative farm in Southern India. Since May, customers can check out how those seeds grew into a collection of dresses.​ ​All of Christy Dawn’s designs are ethically made in Los Angeles by a team of talented seamstresses who are paid a living wage and health benefits.  </p>
                                    <ul>
                                        <li>This effortless minimalistic midi dress can be dressed up or down and worn day or night. </li>
                                        <li>It features oversized sleeves, functional side pockets, and adjustable drawstrings for versatility..</li>
                                        <li>It is completely made of biodegradable material which is completely ecofriendly.</li>
                                    </ul>

                                    <p>This perfect addition to your capsule wardrobe is handwoven, has an optional fabric belt, darts for a tailored look, and pockets! By purchasing this dress, you are helping provide a secure job with fair wages and a positive working environment to artisans in Bangalore, India. . </p>
                                </div><!-- End .product-desc-content -->
                            </div><!-- .End .tab-pane -->
                            <div class="tab-pane fade" id="product-info-tab" role="tabpanel" aria-labelledby="product-info-link">
                                <div class="product-desc-content">
                                    <h3>Information</h3>
                                    <p>This brand is so great when it comes to minimalist wardrobes and versatility. With the Convertible Shirt Dress you are able to wear a dress or a shirt! It’s a very classic relaxed fit look with drop-in pockets, and wears well as a tunic, too. It’s always a plus to have two garments in one! </p>
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="review-content">
                                                    <p>I just love the tassels and different shades of orange. It’s perfect for the time of year, and the ruffle is just too sweet. The Tassle Tie Dress is made from 100% cotton at a fair trade women’s cooperative in India. It has features of hand embroidery, hidden pockets and adjustable ties. </p>
                                    ...
                                    <div class="review">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="review-content">
                                                    <p>Such a classic beauty! You can find this dress at one of my favorite destinations, Made Trade. One of the brands they carry, Mata Traders, is on a mission to create beautiful, slow made, and exceptionally designed clothes for the modern woman. </p>
                                                </div><!-- End .review-content -->
