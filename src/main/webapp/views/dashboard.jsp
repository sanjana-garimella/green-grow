	                		...
	                		<div class="col-md-8 col-lg-9">
	                			<div class="tab-content">
								    ...
								    <div class="tab-pane fade" id="tab-orders" role="tabpanel" aria-labelledby="tab-orders-link">
								    	...
								    	<a href="/tab-orders" class="btn btn-outline-primary-2"><span>View Orders</span><i class="icon-long-arrow-right"></i></a>
								    </div><!-- .End .tab-pane -->

								    <div class="tab-pane fade" id="tab-downloads" role="tabpanel" aria-labelledby="tab-downloads-link">
								    	<p>No downloads available yet.</p>
								    	<a href="/category" class="btn btn-outline-primary-2"><span>GO SHOP</span><i class="icon-long-arrow-right"></i></a>
								    </div><!-- .End .tab-pane -->
								    		...
								    		<div class="col-lg-6">
								    			<div class="card card-dashboard">
								    				<div class="card-body">
														...
														KL University<br>
														Admin<br>
														Green Fields, Vaddeswaram, Andhra Pradesh <br>
														1-234-987-6543<br>
														admin@gmail.com<br>
