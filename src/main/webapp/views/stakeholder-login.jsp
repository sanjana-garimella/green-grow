...
<head>
  <meta charset="UTF-8">
  <title>StakeHolder SignIn</title>
...
<div class="container" id="container">
	<div class="form-container sign-in-container">
		...
		<form method="post" action="/stakeholder-login">
			<h1>Sign in</h1>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-right">
				<h1>New Stakeholder? Want to invest more?</h1>
				<p>Enter your personal details and start journey with us</p>
				<button onclick="location.href = 'stakeholder-register';" id="signUp">Sign Up</button>
			</div>
		</div>
	</div>
</div>
